  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section id="home" className="relative py-32 px-6 text-center overflow-hidden">
          {/* Background decoration */}
          <div className="absolute inset-0 bg-gradient-to-r from-cloud-blue-500/10 via-electric-purple-500/10 to-emerald-green-500/10 animate-gradient-shift"></div>
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-cloud-blue-400/20 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-electric-purple-400/20 rounded-full blur-3xl animate-float-delay"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-emerald-green-400/10 rounded-full blur-3xl animate-float"></div>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-bounce-in" style={{ animationDelay: '0.4s' }}>
              ...
              <a href="#demo" className="inline-flex items-center gap-2 border-2 border-electric-purple-600 text-electric-purple-600 dark:text-electric-purple-400 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-electric-purple-600 hover:text-white transform hover:scale-105 group">
