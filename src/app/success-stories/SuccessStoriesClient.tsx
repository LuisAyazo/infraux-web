      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-4">
                {t('success_stories.featured_title')}
              </h2>
              <p className="text-xl text-slate-600 dark:text-slate-400">
                {t('success_stories.featured_desc')}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-4">
                {t('success_stories.industry_title')}
              </h2>
              <p className="text-xl text-slate-600 dark:text-slate-400">
                {t('success_stories.industry_desc')}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
            <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-6">
              {t('success_stories.cta_title')}
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 mb-10">
              {t('success_stories.cta_desc')}
            </p>
            <a
              href="/register"
              className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold text-lg rounded-full shadow-premium hover:shadow-premium-lg transform hover:scale-[1.02] transition-all duration-300"
            >
              {t('success_stories.cta_button')}
